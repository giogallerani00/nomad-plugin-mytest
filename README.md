...
```sh
git clone https://github.com/giogallerani00/nomad-plugin-mytest.git
cd nomad-plugin-mytest
...
```sh
pip install dist/nomad-plugin-mytest-0.1.0
```
...
| Name | E-mail     |
|------|------------|
| Giovanni Gallerani | [giovanni.gallerani@edu.unife.e.it](mailto:giovanni.gallerani@edu.unife.e.it)
